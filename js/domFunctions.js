...
export const setPlaceholderText = () => {
    ...
    window.innerWidth < 400 
        ? (input.placeholder = "City, Region, Country")
        : (input.placeholder = "City, Region, Country or Zip Code");
};

//------------Spinn refresh sign after clicking----------
...
// -------- Geolocation in browser is denied-----------
...
//-----Appear with animation CurrentForecast and DaiLyForecast---------
const fadeDisplay = () => {
...
const setFocusSearch = () => {
    document.getElementById("searchBar__text");
};

//--------Creating Current Conditions at the WebPage-----------------
